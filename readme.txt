...
The Clinical Trial Search application is a stylized search engine that allows the intended users such Medical students, professionals, or simply the medically literate, to be able to search a curated library of Clinical Trial Information based on a variety of criteria related to the trial. Such criteria is not limited just to the trial itself, but also about journals that have mentioned the trial, or the instutitions and healthcare personnel that were involved in the trial. This allows the users to use the Search Engine as the center of a much large investigation into the details of related medical information.

Users are required to register and login to a user database in order to use the application. While users cannot edit any of the curated information, this requirement ensures the site is not overwelmed with traffic ensuring fast connections and better ease of use.
...
#Glitches
*Rarely, if the application is connected to via the [soic.edu] servers, then a slowed connection could cause the signin page to, upon a successful signin, get trapped on the [signin.inc.php] page for reasons unknown. 

*Users can theoretically access the backend application layer pages in the inproper order without their proper forms from the [main] directory files by typing their location directly into the url. While all the pages should have proper protections for this via header statements, doing so for the url ]https://in-info-web4.informatics.iupui.edu ~ajettpac/Al_Austin_Koshy_Project/Clinical_Trial_Search/inc /functions.inc.php] will lead the user to blank page with no links or exits. 


## Credits
Nicole Koshy,
School of Informatics and Computing, Indiana University - Purdue University Indianapolis, nickoshy@iu.edu

Alden Jettpace,
School of Informatics and Computing, Indiana University - Purdue University Indianapolis, ajettpac@iu.edu

Austin Anderson,
School of Informatics and Computing, Indiana University - Purdue University Indianapolis, andersau@iu.edu
